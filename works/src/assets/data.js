export const data = {
  ...
  ja: {
    header: [
      "ㅇㅇ더 나은 UI/UX와 조화로운 협업으로, 사용자와 개발자가 모두 만족하는 UI를 만드는 장영주입니다.",
      "ㅋㅋ웹 퍼블리싱으로 시작하여 프론트엔드 개발까지, UI/UX 개선과 중간 역할을 수행하여 프로젝트를 성공적으로 완수했습니다. 디자이너, 기획자, 개발자와 원활한 협업을 통해 디자인 시스템을 정리하고, UI/UX 개선하며 프로젝트를 성공적으로 완수했습니다.",
      "ㅇㅇㅇㅇㅇ기획자와 디자이너 사이에서 비개발 직군과 원활한 작업진행에 도움이 되는 것에 보람을 느낍니다.",
    ],
    career: [
      {
        id: 1,
